...
/**
 * HERO
 * The first screen: name, title, tagline, and two calls to action.
 *
 ...
 *   /public/resume.pdf to replace the placeholder file. The `download`
 *   attribute makes the browser save it instead of navigating to it.
 *
 * All copy lives in data/profile.ts.
 */
    ...
    >
      ...
      <div className="relative mx-auto w-full max-w-content px-6 py-20 sm:px-8">
        <div className="max-w-3xl">
          ...
          {/* Name */}
          <Reveal delay={0.05}>
            <h1 className="mt-6 text-4xl font-bold tracking-tight text-slate-900 sm:text-6xl lg:text-7xl dark:text-white">
              {profile.name}
            </h1>
          </Reveal>
