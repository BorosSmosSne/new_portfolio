...
export function FacebookIcon(props: IconProps) {
  return (
    <svg viewBox="0 0 24 24" aria-hidden="true" fill="currentColor" {...props}>
      <path d="M22 12.06C22 6.5 17.52 2 12 2S2 6.5 2 12.06c0 4.99 3.66 9.13 8.44 9.94v-7.03H7.9v-2.91h2.54V9.85c0-2.51 1.49-3.9 3.77-3.9 1.1 0 2.24.2 2.24.2v2.47h-1.26c-1.24 0-1.63.77-1.63 1.57v1.87h2.78l-.45 2.91h-2.33V22c4.78-.81 8.44-4.95 8.44-9.94Z" />
    </svg>
  );
}
...
export function FigmaIcon(props: IconProps) {
  return (
    <svg viewBox="0 0 24 24" aria-hidden="true" fill="currentColor" {...props}>
      {/* Five shapes of the Figma mark, drawn in a single colour. */}
      <path d="M11.75 2H8.5a3.5 3.5 0 0 0 0 7h3.25V2Z" />
      <path d="M12.25 2h3.25a3.5 3.5 0 0 1 0 7h-3.25V2Z" />
      <path d="M11.75 9.5H8.5a3.5 3.5 0 0 0 0 7h3.25v-7Z" />
      <circle cx="15.5" cy="13" r="3.5" />
      <path d="M11.75 17H8.5A3.5 3.5 0 1 0 11.75 20.5V17Z" />
    </svg>
  );
}
